        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td ><a href="JavaScript:if(confirm('Confirm Edit?')==true){window.location='emp_editForm.php?userID=<?php echo $row['user_id'];?>';} "class="btn btn-warning">Edit</a></td>
                    <td ><a href="JavaScript:if(confirm('Confirm Delete?')==true){window.location='emp_delete.php?userID=<?php echo $row['user_id'];?>';}"class="btn btn-danger">Delete</a></td>
