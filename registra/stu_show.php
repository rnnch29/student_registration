        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="JavaScript:if(confirm('Confirm Edit?')==true){window.location='form/stu_editForm.php?userID=<?php echo $row['user_id'];?>';}" class="btn btn-warning">แก้ไข</a></td>
                    <td><a href="JavaScript:if(confirm('Confirm Delete?')==true){window.location='funtion/stu_del.php?userID=<?php echo $row['user_id'];?>';}" class="btn btn-danger">Delete</a></td>
                </tr>
                <?php endwhile; ?>
            </tbody>
        </table>
